...
import { idlFactory } from './messaging_system.did.js';
export { idlFactory } from './messaging_system.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MESSAGING_SYSTEM;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./messaging_system.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the messaging_system canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./messaging_system.did.js")._SERVICE>}
 */
export const messaging_system = createActor(canisterId);
