...
import { idlFactory } from './bounties.did.js';
export { idlFactory } from './bounties.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BOUNTIES;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bounties.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bounties canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bounties.did.js")._SERVICE>}
 */
export const bounties = createActor(canisterId);
