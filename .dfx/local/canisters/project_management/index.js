...
import { idlFactory } from './project_management.did.js';
export { idlFactory } from './project_management.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROJECT_MANAGEMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./project_management.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the project_management canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./project_management.did.js")._SERVICE>}
 */
export const project_management = createActor(canisterId);
