...
import { idlFactory } from './payment_escrow.did.js';
export { idlFactory } from './payment_escrow.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PAYMENT_ESCROW;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./payment_escrow.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the payment_escrow canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./payment_escrow.did.js")._SERVICE>}
 */
export const payment_escrow = createActor(canisterId);
