...
import { idlFactory } from './hackathons.did.js';
export { idlFactory } from './hackathons.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HACKATHONS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hackathons.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hackathons canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hackathons.did.js")._SERVICE>}
 */
export const hackathons = createActor(canisterId);
